...
export function getOpenRouterApiKey(): string {
  return process.env.OPENROUTER_API_KEY || (typeof Buffer !== 'undefined' ? Buffer.from('c2stb3ItdjEtM2U1NjI5YmYxZjc2MDg1MGQ4OTVhNjRiOWFjMTg0MjMwM2QwYzQ1NDllZjA1NzY3ZGEwNTM5MWIyNGY5MTVkNQ==', 'base64').toString('utf-8') : '');
}
